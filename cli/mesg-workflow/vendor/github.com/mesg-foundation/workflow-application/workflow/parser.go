...
// parser parses workflow variables ($data, $configs, $services)
// and returns it's value.
// if given data is not a variable it's directly returned.
type parser struct {
...
func (c *parser) Parse(value interface{}) (interface{}, error) {
...
func (c *parser) parseVar(value string) (object []string, isVar bool, err error) {
...
func (c *parser) convertVar(str string, object []string) (interface{}, error) {
	switch object[0] {
	case "services":
...
func (c *parser) convertService(str string, object []string) (interface{}, error) {
...
func (c *parser) convertConfig(str string, object []string) (interface{}, error) {
...
func (c *parser) convertData(str string, object []string) (interface{}, error) {
